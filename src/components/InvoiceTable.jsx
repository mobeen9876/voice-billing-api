    ...
    <div className={styles.card}>
      ...
      <div className={styles.tableWrapper}>
        <table className={styles.table}>
          ...
          <tfoot>
            <tr className={styles.subtotalRow}><td colSpan="4">Subtotal</td><td>Rs. {invoice.subtotal.toLocaleString()}</td></tr>
            <tr className={styles.totalRow}><td colSpan="4">Total</td><td>Rs. {invoice.total.toLocaleString()}</td></tr>
          </tfoot>
        </table>
      </div>
